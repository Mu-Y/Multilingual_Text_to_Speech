...
if __name__ == '__main__':
    ...
    for task_idx, train_lang in enumerate(hp.training_langs, 1):
        ...
        train_data = DataLoader(dataset.train, batch_size=hp.batch_size, drop_last=True, shuffle=shuffle, sampler=sampler, collate_fn=TextToSpeechCollate(True), num_workers=args.loader_workers)
